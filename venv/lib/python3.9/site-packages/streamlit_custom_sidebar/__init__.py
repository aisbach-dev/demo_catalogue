...
class CustomSidebarDefault:
    ...
    def __init__(self, openSidebarBtnColor="auto", closeSidebarBtnColor="auto", backgroundColor="black", activeBackgroundColor="red", navigationHoverBackgroundColor="gray", labelIconSize="17px", distanceIconLabel="12px", labelIconColor="white", closeNavOnLoad=True, loadPageName=None, LocalOrSessionStorage=0, serverRendering=False, data=None, webMedium="local", iframeContainer=None) -> None: 
                        ...
                        if (sidebar.length < 1){{
                            ...
                            if ("{self.loadPageName}" === "None"){{
                                ...
                                if (pageName_ === ""){{
                                  ...
                                  // window.top.document.head.querySelectorAll('title')[0].innerHTML.split("·")[0].trim(); 
                            
                                
                            }} else {{
                                
                                {self.storageChoice}.setItem("currentPage", JSON.stringify({{"currentPage":"{self.loadPageName}"}}))
                            ...
                            {self.data}.forEach((el) => {{
                                ...
                                if ("{self.serverRendering}" === "True"){{
                                    ...
                                    navTabContent.className = "contents-container";
                                    navTabContent.style = "display:flex; flex-direction:row; align-items:center; cursor:pointer; padding:3px; padding-left:4px; border-radius:0.25rem; margin-left:5px; margin-right:5px; margin-bottom:3.5px;";
                                    ...
                                    const labelEl = document.createElement('span');
                                    labelEl.className = "navigation-label";
                                    labelEl.dataset.testid = el.page;
                                    labelEl.innerHTML = el.label;
                                    labelEl.style = "white-space:nowrap; display:table-cell;";
                                    labelEl.style.fontSize = "{self.labelIconSize}";
                                    labelEl.style.color = "{self.labelIconColor}";
                            ...
                            let iframeScreenComp = window.top.document.querySelectorAll('iframe[srcdoc*="sidebar"]')
                    ...
                    <script>
                        ...
                        navigationTabs.forEach((c) => {{
                            c.addEventListener("click", (e) => {{
                                ...
                                {self.storageChoice}.setItem("currentPage", JSON.stringify({{"currentPage":c.querySelectorAll('span')[0].getAttribute('data-testid')}})); //c.querySelectorAll('span')[0].innerHTML.toLowerCase()
    ...
    def change_page(self, key="getPage"):
        """
        ...
        if self.storageChoice == "localStorage":
            localS = LocalStorage()
            pageSelect = localS.getItem("currentPage",key=key)
        else:
            sessionS = SessionStorage()
            pageSelect = sessionS.getItem("currentPage", key=key)
